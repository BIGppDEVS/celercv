const Footer = () => {
  return (
    <footer className="w-full py-6 px-4 md:px-12 mx-auto border-t">
      <div className="grid grid-cols-1 md:grid-cols-3 items-center gap-5 text-center md:text-left">
        <a
          className="flex-none font-mono text-xl font-semibold dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
          href="#"
          aria-label="celerCV"
        >
          celerCV
